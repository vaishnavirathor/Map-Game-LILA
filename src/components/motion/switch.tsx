      ...
      <span className={cn("inline-flex items-center gap-3", className)}>
        <motion.button
          ...
          className={cn(
            ...
            "focus-visible:ring-2 focus-visible:ring-zinc-400/20 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950",
            "disabled:cursor-not-allowed disabled:opacity-60",
            checked ? "justify-end bg-blue-600" : "justify-start bg-zinc-600",
          )}
        >
          <motion.div
            ref={thumbRef}
